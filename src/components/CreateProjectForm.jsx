...
export const CreateProjectForm = ({ onClose }) => {
  ...
  // Hook personalizado para manejar proyectos
  ...
  const handleSubmit = async (e) => {
    ...
    //uso del custom hook para crear el proyecto
    ...
    if (result.success) {
      ...
      alert(`Ocurrió un error al guardar el proyecto: ${result.error}`);
    }
  };
    ...
    <div className="bg-white flex flex-col w-full" style={{ fontFamily: 'Roboto, sans-serif' }}>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 ${errors.folio
              ...
              <div>
                ...
                <select
                  ...
                  value={form.status}
                  onChange={handleChange}
                  className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 ${errors.status
                    ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                    : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                    }`}
                  style={{ fontFamily: 'Roboto, sans-serif' }}
            ...
            <div className="mt-6">
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 ${errors.title
                  ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                  : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                  }`}
                style={{ fontFamily: 'Roboto, sans-serif' }}
            ...
            <div className="mt-6">
              ...
              <textarea
                ...
                className={`w-full px-4 py-2.5 border rounded-lg h-24 resize-none transition-all duration-200 ${errors.description
                  ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                  : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                  }`}
                style={{ fontFamily: 'Roboto, sans-serif' }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-2.5 border rounded-lg h-28 resize-none transition-all duration-200 ${errors.general_objective
                    ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                    : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                    }`}
                  style={{ fontFamily: 'Roboto, sans-serif' }}
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-2.5 border rounded-lg h-28 resize-none transition-all duration-200 ${errors.specific_objectives
                    ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                    : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                    }`}
                  style={{ fontFamily: 'Roboto, sans-serif' }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  value={form.type}
                  onChange={handleChange}
                  className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 ${errors.type
                    ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                    : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                    }`}
                  style={{ fontFamily: 'Roboto, sans-serif' }}
              ...
              <div>
                ...
                <select
                  ...
                  value={form.area}
                  onChange={handleChange}
                  className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 ${errors.area
                    ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                    : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                    }`}
                  style={{ fontFamily: 'Roboto, sans-serif' }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 ${errors.creation_date
                    ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                    : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                    }`}
                  style={{ fontFamily: 'Roboto, sans-serif' }}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 ${errors.completion_date
                    ? "border-red-400 bg-red-50 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                    : "border-gray-300 bg-white focus:border-blue-900 focus:ring-2 focus:ring-blue-100"
                    }`}
                  style={{ fontFamily: 'Roboto, sans-serif' }}
      ...
      <div className="px-8 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
        ...
        <button
          ...
          className={`px-6 py-2.5 rounded-lg font-semibold transition-all duration-200 ${isFormValid()
